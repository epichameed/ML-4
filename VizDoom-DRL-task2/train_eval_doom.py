    ...
    def make_env(self, seed=None, capture_video=False):
        ...
        def make_env_fn():
            def _init():
                ...
                env = Monitor(env, os.path.join("logs", f"seed_{seed}" if seed is not None else "tmp"))
                return env
            return _init
    ...
    def train_and_evaluate(self):
        ...
        for policy_type in self.policies:
            ...
            for seed in range(self.n_seeds):
                ...
                # Save model
                try:
                    model.save(f"models/{policy_type}_seed{seed}")
                except Exception as e:
            ...
            if policy_results:
                ...
                # Save policy results
                with open(f"logs/{policy_type}_results.json", 'w') as f:
